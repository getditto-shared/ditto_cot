...
@protocol DITAWDLClientPeer;
@protocol DITAWDLClientBrowser;
...
@property(nonatomic, strong, nullable) NSObject<DITAWDLClientBrowser> *browser;
@property(nonatomic, strong) NSMutableDictionary<NSString *, NSObject<DITAWDLClientPeer> *> *peers;
