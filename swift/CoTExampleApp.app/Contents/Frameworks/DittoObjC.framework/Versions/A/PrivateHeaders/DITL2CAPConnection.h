...
- (instancetype)initWithChannel:(CBL2CAPChannel *)channel handle:(DITTransportHandleWrapper *)handle isServer:(BOOL)isServer uuid:(NSUUID*)uuid runLoop:(NSRunLoop *)runLoop thread:(NSThread *)thread;
...
@property (nonatomic, readonly) NSRunLoop *transportsRunLoop;
@property (nonatomic, readonly) NSThread *transportsThread;
